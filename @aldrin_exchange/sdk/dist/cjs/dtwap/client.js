...
var DTwapClient = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        searchFilters = [
                            { dataSize: layout_1.DTWAP_PAIR_SETTINGS.span },
                        ];
                        return [4 /*yield*/, this.connection.getProgramAccounts(__1.DTWAP_PROGRAM_ADDRESS, {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, accounts.map(function (p) {
                                ...
                                var account = layout_1.DTWAP_PAIR_SETTINGS.decode(data);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        searchFilters = [
                            { dataSize: layout_1.DTWAP_ORDER_ARRAY.span },
                        ];
                        if (pairSettings) {
                            offset = layout_1.DTWAP_ORDER_ARRAY.offsetOf('pairSettings');
                            if (offset === undefined) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, accounts.map(function (p) {
                                var data = p.account.data, pubkey = p.pubkey;
                                var account = layout_1.DTWAP_ORDER_ARRAY.decode(data);
                                return __assign(__assign({}, account), { side: account.side.ask ? types_1.SIDE.ASK : types_1.SIDE.BID, orders: account.orders
    ...
    DTwapClient.prototype.getAvailableTokens = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        transaction = new web3_js_1.Transaction().add(_1.TwAmm.getAvailableTokensInstruction(params));
                        return [4 /*yield*/, (0, transactions_1.simulateTransaction)({
                    ...
                    case 1:
                        ...
                        if (simulation.value.logs) {
                            ...
                            return [2 /*return*/, _1.DTWAP_AVAILABLE_TOKENS.decode(data)];
                        }
                        return [2 /*return*/, { amountFrom: new bn_js_1.default(0), amountTo: new bn_js_1.default(0) }];
                }
            });
        });
    };
    ...
    DTwapClient.prototype.executeSwap = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var transaction;
            return __generator(this, function (_a) {
                transaction = new web3_js_1.Transaction().add(_1.TwAmm.executeSwapInstruction(params));
                return [2 /*return*/, (0, transactions_1.sendTransaction)({ transaction: transaction, wallet: params.wallet, connection: this.connection })];
            });
        });
    };
    return DTwapClient;
}());
exports.DTwapClient = DTwapClient;
