...
var PoolClient = /** @class */ (function () {
    function PoolClient(connection) {
        ...
        this.tokenClient = new __1.TokenClient(this.connection);
    }
    PoolClient.getPoolAddress = function (poolVersion) {
        return poolVersion === 1 ? __1.POOLS_PROGRAM_ADDRESS : __1.POOLS_V2_PROGRAM_ADDRESS;
    };
    /**
    ...
    PoolClient.prototype.getPools = function (filters) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        _a = [{ dataSize: _1.POOL_LAYOUT.span }];
                        _d = {};
                        _e = {
                            offset: 0
                        };
                        _c = (_b = bs58_1.default).encode;
                        return [4 /*yield*/, (0, utils_1.accountDiscriminator)('Pool')];
                    case 1:
                        ...
                        if (filters.mint) {
                            searchFilters.push({ memcmp: { offset: _1.POOL_LAYOUT.offsetOf('poolMint') || 0, bytes: filters.mint.toBase58() } });
                        }
                        return [4 /*yield*/, this.connection.getProgramAccounts(__1.POOLS_PROGRAM_ADDRESS, {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, accounts.map(function (p) {
                                ...
                                var account = _1.POOL_LAYOUT.decode(data);
                                return __assign(__assign({}, account), { poolPublicKey: pubkey, poolVersion: 1, curveType: _1.CURVE.PRODUCT });
                            })];
                }
            });
        });
    ...
    PoolClient.prototype.getV2Pools = function (filters) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        _a = [{ dataSize: _1.POOL_V2_LAYOUT.span }];
                        _d = {};
                        _e = {
                            offset: 0
                        };
                    ...
                    case 1:
                        ...
                        if (filters.mint) {
                            searchFilters.push({ memcmp: { offset: _1.POOL_V2_LAYOUT.offsetOf('poolMint') || 0, bytes: filters.mint.toBase58() } });
                        }
                        return [4 /*yield*/, this.connection.getProgramAccounts(__1.POOLS_V2_PROGRAM_ADDRESS, {
                                filters: searchFilters,
                            })];
                    case 2:
                        accounts = _f.sent();
                        return [2 /*return*/, accounts.map(function (p) {
                                var data = p.account.data, pubkey = p.pubkey;
                                var account = _1.POOL_V2_LAYOUT.decode(data);
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, __1.TokenClient.createTokenAccountTransaction({
                    ...
                    case 4:
                        ...
                        _d.label = 5;
                    case 5:
                        instruction = pool_1.Pool.depositLiquididtyInstruction(__assign(__assign({}, params), { walletAuthority: wallet.publicKey, poolSigner: poolSigner, userPoolTokenAccount: userPoolTokenAccount, creationSize: creationSize, programId: programId }));
                ...
                switch (_h.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __1.TokenClient.createTokenAccountTransaction({
                                owner: wallet.publicKey,
                                mint: baseTokenMint,
                                amount: side === types_1.SIDE.ASK ? parseInt(outcomeAmount.toString(), 10) + TOKEN_ACCOUNT_RENT_LAMPORTS : undefined,
                            })];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, __1.TokenClient.createTokenAccountTransaction({
                                owner: wallet.publicKey,
                                mint: quoteTokenMint,
                                amount: side === types_1.SIDE.BID ? parseInt(outcomeAmount.toString(), 10) + TOKEN_ACCOUNT_RENT_LAMPORTS : undefined,
                            })];
                    case 3:
                    ...
                    case 5:
                        ...
                        transaction.add(pool_1.Pool.swapInstruction(__assign(__assign({}, params), { minIncomeAmount: minIncomeAmount, poolSigner: poolSigner, walletAuthority: wallet.publicKey, userBaseTokenAccount: userBaseTokenAccount, userQuoteTokenAccount: userQuoteTokenAccount, poolVersion: poolVersion })));
                        if (baseTokenMint.equals(_1.SOL_MINT)) {
                            transaction.add(spl_token_1.Token.createCloseAccountInstruction(spl_token_1.TOKEN_PROGRAM_ID, userBaseTokenAccount, wallet.publicKey, wallet.publicKey, []));
                        }
                        if (quoteTokenMint.equals(_1.SOL_MINT)) {
                            transaction.add(spl_token_1.Token.createCloseAccountInstruction(spl_token_1.TOKEN_PROGRAM_ID, userQuoteTokenAccount, wallet.publicKey, wallet.publicKey, []));
                        }
                        if (!referralParams) return [3 /*break*/, 9];
                        refFeeAmount = new utils_1.u64(minIncomeAmount.mul(__1.PRECISION_NOMINATOR.muln(referralParams.referralPercent).divn(100)).div(__1.PRECISION_NOMINATOR));
                        incomeMint_1 = (side === types_1.SIDE.ASK ? params.pool.quoteTokenMint : params.pool.baseTokenMint).toString();
                        takeFeesFromAccount = side === types_1.SIDE.ASK ? userQuoteTokenAccount : userBaseTokenAccount;
                    ...
                    case 6:
                        ...
                        feesDestination = incomeMint_1 === _1.SOL_MINT.toString() ? referralParams.referralAccount : (_a = walletTokens.find(function (wt) { return wt.account.data.parsed.info.mint === incomeMint_1; })) === null || _a === void 0 ? void 0 : _a.pubkey;
                        if (!(!feesDestination && referralParams.createTokenAccounts)) return [3 /*break*/, 8];
                        return [4 /*yield*/, __1.TokenClient.createTokenAccountTransaction({
                                owner: referralParams.referralAccount,
                                mint: new web3_js_1.PublicKey(incomeMint_1),
                    ...
                    case 8:
                        ...
                        if (incomeMint_1 === _1.SOL_MINT.toString()) {
                            ...
                            transaction.add(spl_token_1.Token.createTransferInstruction(spl_token_1.TOKEN_PROGRAM_ID, takeFeesFromAccount, feesDestination, wallet.publicKey, [], parseInt(refFeeAmount.toString(), 10)));
                        }
                        _h.label = 9;
                    case 9: return [2 /*return*/, (0, transactions_1.sendTransaction)({
                            wallet: wallet,
                            connection: this.connection,
                            transaction: transaction,
                        })];
