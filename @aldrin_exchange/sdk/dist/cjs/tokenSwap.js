...
var TokenSwap = /** @class */ (function (_super) {
    ...
    function TokenSwap(pools, poolClient, tokenClient, farmingClient, connection, wallet, referralParams) {
        if (connection === void 0) { connection = new web3_js_1.Connection(pools_1.SOLANA_RPC_ENDPOINT); }
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!minIncomeAmount) {
                            ...
                            B = outcomeAmount;
                            minIncomeAmount = curveType === pools_1.CURVE.STABLE
                                ? outcomeAmount
                                : X
                                    .sub(X.mul(Y)
                                    .div(Y.add(B)));
                        ...
                        if (!outcomeAmount) {
                            A = minIncomeAmount;
                            outcomeAmount = curveType === pools_1.CURVE.STABLE
                                ? minIncomeAmount
                                : X
                                    .mul(Y)
                                    .div(X.sub(A))
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                ...
                                side: isInverted ? pools_1.SIDE.ASK : pools_1.SIDE.BID,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        fee = outcomeAmount.mul(pools_1.SWAP_FEE_NUMERATOR).div(pools_1.SWAP_FEE_DENOMINATOR);
                        return [2 /*return*/, {
                                minIncomeAmount: minIncomeAmount,
                                outcomeAmount: outcomeAmount,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _b = _c.sent(), baseVaultAccount = _b[0], quoteVaultAccount = _b[1];
                        price = quoteVaultAccount.amount.mul(_1.PRECISION_NOMINATOR).div(baseVaultAccount.amount);
                        return [4 /*yield*/, this.getWalletTokens(wallet)];
                    case 2:
                        walletTokens = _c.sent();
                        ...
                        if (!maxBase) {
                            ...
                            maxBase = maxQuote.mul(_1.PRECISION_NOMINATOR).div(price);
                        }
                        if (!maxQuote) {
                            maxQuote = maxBase.mul(price).div(_1.PRECISION_NOMINATOR);
                        }
                    ...
                    case 1:
                        ...
                        if (poolVersion === 2) {
                            ...
                            if (curveType === 1) {
                                ...
                                outputAmount = (0, stablecurve_1.computeOutputAmount)(amountToSwap, poolInputAmount, poolOutputAmount, new bn_js_1.default(170));
                                return [2 /*return*/, parseFloat(outputAmount
                                        ...
                                        .toString()) / parseFloat(amountToSwap.toString()) / _1.PRECISION_NOMINATOR.toNumber()];
                            }
                        }
                        ...
                        if (isInverted) {
                            return [2 /*return*/, _1.PRECISION_NOMINATOR.toNumber() / price.toNumber()];
                        }
                        return [2 /*return*/, price.toNumber() / _1.PRECISION_NOMINATOR.toNumber()];
                }
            });
        });
    };
    ...
    TokenSwap.initialize = function (params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = params.connection, connection = _a === void 0 ? new web3_js_1.Connection(pools_1.SOLANA_RPC_ENDPOINT) : _a, wallet = params.wallet;
                        poolClient = new pools_1.PoolClient(connection);
                        tokenClient = new _1.TokenClient(connection);
                        farmingClient = new _1.FarmingClient(connection);
                        return [4 /*yield*/, Promise.all([
                                poolClient.getPools(),
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        programId = pools_1.PoolClient.getPoolAddress(pool.poolVersion);
                        return [4 /*yield*/, web3_js_1.PublicKey.findProgramAddress([pool === null || pool === void 0 ? void 0 : pool.poolPublicKey.toBuffer()], programId)];
                    case 2:
                                ...
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [4 /*yield*/, _1.TokenClient.createTokenAccountTransaction({
                                        ...
                                        case 3:
                                            if (state.calcAccount) {
                                                withdrawInstruction = _1.Farming.withdrawFarmedInstruction({
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, Promise.all(transactions
                                .flat()
                                .map(function (_) { return new web3_js_1.Transaction().add(_); })
