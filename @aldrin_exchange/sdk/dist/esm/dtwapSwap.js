...
import { PRECISION_NOMINATOR, SOLANA_RPC_ENDPOINT, TokenClient, DTwapClient } from '.';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        side = isInverted ? SIDE.BID : SIDE.ASK;
                        decimalsFrom = new BN(10).pow(new BN(isInverted ? quoteMintDecimals : baseMintDecimals));
                        decimalsTo = new BN(10).pow(new BN(isInverted ? baseMintDecimals : quoteMintDecimals));
                    ...
                    case 2:
                        ...
                        pricesWithAmount = allAmounts
                            ...
                            var price = orderWithAvailable.available.amountFrom
                                ...
                                .div(decimalsTo);
                            return __assign(__assign({}, orderWithAvailable), { price: price.toNumber() / PRECISION_NOMINATOR.toNumber() });
                        })
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        dtwapClient = new DTwapClient(connection);
