...
export var DTWAP_ORDER_ARRAY = struct([
    blob(8, 'padding'),
...
export var GET_AVAILABLE_TOKENS_LAYOUT = struct([
    blob(8, 'instruction'),
]);
export var DTWAP_AVAILABLE_TOKENS = struct([
    u32('length'),
    int64('amountTo'),
    int64('amountFrom'),
]);
