...
export var SOL_MINT = new PublicKey('So11111111111111111111111111111111111111112');
var POOLS = {
    RIN_USDC: {
...
export var AUTHORIZED_POOLS = POOLS;
export var PERMISSIONLESS_POOLS = PERM_POOLS;
export var PRE_VESTING_NUMERATOR = new BN(1); // User receive 1/3 of reward if vesting not ended
export var PRE_VESTING_DENOMINATOR = new BN(3); // User receive 1/3 of reward if vesting not ended
export var VESTING_NUMERATOR = new BN(2); // User receive another 2/3 of reward if vesting  ended
export var VESTING_DENOMINATOR = new BN(3); // User receive another 2/3 of reward if vesting not ended
export var SWAP_FEE_NUMERATOR = new BN(3);
export var SWAP_FEE_DENOMINATOR = new BN(1000);
// export const SOLANA_RPC_ENDPOINT = 'https://api.mainnet-beta.solana.com'
export var SOLANA_RPC_ENDPOINT = 'https://api-cryptocurrencies-ai.rpcpool.com';
