...
const getCoinQuote = (inputMint, outputMint, amount) =>
  got
    .get(
      `https://quote-api.jup.ag/v1/quote?outputMint=${outputMint}&inputMint=${inputMint}&amount=${amount}&slippage=0.1&swapMode=ExactIn`
    )
    .json();
...
var returns = ((((usdcToSol.data[0].outAmount / 10 ** dec2  )/ (initial))- 1))
console.log(returns)
  if (returns > 0.02){
