...
exports.getSarosPools = void 0;
const web3_js_1 = require("@solana/web3.js");
const common_1 = require("./common");
const types_1 = require("../../types/types");
function getSarosPools(connection) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < programAccounts.length; i++)
            promises.push(web3_js_1.PublicKey.findProgramAddress([programAccounts[i].publicKey.toBuffer()], new web3_js_1.PublicKey(types_1.SAROS_PROGRAM_ID)));
        let pools = {};
        yield Promise.all(promises).then(results => {
            for (let i = 0; i < programAccounts.length; i++) {
                let decoded = types_1.SAROS_SWAP_LAYOUT.decode(programAccounts[i].accountInfo.data);
                let pool = Object.assign(Object.assign({}, decoded), { authority: results[i][0], swapAccount: programAccounts[i].publicKey.toBase58(), provider: "saros" });
