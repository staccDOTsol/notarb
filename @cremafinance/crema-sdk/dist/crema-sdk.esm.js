...
import { blob, struct, s32, u8, seq, u32 } from '@solana/buffer-layout';
import { PublicKey, TransactionInstruction, clusterApiUrl, sendAndConfirmTransaction as sendAndConfirmTransaction$1, Transaction, SystemProgram, Keypair } from '@solana/web3.js';
import BN from 'bn.js';
import { TOKEN_PROGRAM_ID, Token, ASSOCIATED_TOKEN_PROGRAM_ID, AccountLayout, u64, MintLayout } from '@solana/spl-token';
...
function calculateSlidTokenAmount(tickLower, tickUpper, liquity, currentSqrtPrice, slid) {
  !(slid.lessThan(1) && slid.greaterThan(0)) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid slid:" + slid.toString()) : invariant(false) : void 0;
  var maxSqrtPrice = currentSqrtPrice.mul(new Decimal(1).add(slid).sqrt());
  var minSqrtPrice = currentSqrtPrice.mul(new Decimal(1).sub(slid).sqrt());
...
function sqrtPrice2Tick(sqrtPrice) {
  !sqrtPrice.lessThanOrEqualTo(MAX_SQRT_PRICE) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid sqrtPrice: " + sqrtPrice.toString() + " Max: " + MAX_SQRT_PRICE.toString() + ", too large") : invariant(false) : void 0;
  !sqrtPrice.greaterThanOrEqualTo(MIN_SQRT_PRICE) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid sqrtPrice: " + sqrtPrice.toString() + ", Min: " + MIN_SQRT_PRICE.toString() + ", too small") : invariant(false) : void 0;
...
function price2Tick(price) {
  !price.lessThan(MAX_PRICE) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid price:" + price.toString() + " Max: " + MAX_PRICE.toString() + ",  too large") : invariant(false) : void 0;
  !price.greaterThan(MIN_PRICE) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid price:" + price.toString() + " Min: " + MIN_PRICE.toString() + ", too small") : invariant(false) : void 0;
...
function tick2Price(tick) {
  !(tick >= MIN_TICK && tick <= MAX_TICK) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid tick: " + tick + ", must be in range [" + MIN_TICK.toString() + ", " + MAX_TICK.toString() + "]") : invariant(false) : void 0;
...
function getNearestTickBySqrtPrice(sqrtPrice, tickSpace) {
  ...
  !sqrtPrice.lessThan(MAX_SQRT_PRICE) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid sqrtPrice: " + sqrtPrice.toString() + " Max: " + MAX_SQRT_PRICE.toString() + ", too large") : invariant(false) : void 0;
  !sqrtPrice.greaterThan(MIN_SQRT_PRICE) ? process.env.NODE_ENV !== "production" ? invariant(false, "Invalid sqrtPrice: " + sqrtPrice.toString() + ", Min: " + MIN_SQRT_PRICE.toString() + ", too small") : invariant(false) : void 0;
...
var parseTicksAccount = function parseTicksAccount(pubkey, info) {
  ...
  var Layout = struct([u8("swapVersion"), publicKey("tokenSwapKey"), u8("accountType"), s32("len"), blob(info.data.length - 38, "dataFlat")], "ticksAccount");
  var buffer = Buffer.from(info.data);
...
var DataLayout$5 = /*#__PURE__*/struct([/*#__PURE__*/u8("instruction"), /*#__PURE__*/decimalU64("amountIn"),
/*#__PURE__*/
...
var DataLayout$6 = /*#__PURE__*/struct([/*#__PURE__*/u8("instruction"), /*#__PURE__*/decimalU64("amountIn"), /*#__PURE__*/decimalU64("minimumAmountOut")]);
...
var DataLayout$7 = /*#__PURE__*/struct([/*#__PURE__*/u8("instruction"), /*#__PURE__*/decimalU64("liquityAmount"), /*#__PURE__*/decimalU64("minimumTokenA"), /*#__PURE__*/decimalU64("minimumTokenB"), /*#__PURE__*/decimalU64("positionIndex")]);
...
var url = process.env.RPC_URL || (process.env.LIVE ? /*#__PURE__*/clusterApiUrl(cluster, false) : "http://localhost:8899");
var urlTls = process.env.RPC_URL || (process.env.LIVE ? /*#__PURE__*/clusterApiUrl(cluster, true) : "http://localhost:8899");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            !(account !== null) ? process.env.NODE_ENV !== "production" ? invariant(false, "the account is null") : invariant(false) : void 0;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 4:
              ...
              !(positionInfo !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, "Position:" + positionId.toString() + " not found") : invariant(false) : void 0;
              payer = payer !== null ? payer : this.payer;
...
export { INIT_KEY, MAX_ACCOUNT_POSITION_LENGTH, MAX_PRICE, MAX_SQRT_PRICE, MAX_TICK, MIN_PRICE, MIN_SQRT_PRICE, MIN_TICK, PIECES, POSITIONS_ACCOUNT_SIZE, POSITIONS_ACCOUNT_TYPE, PRICE_OFFSET, PositionLayout, PositionsAccountLayout, TICKS_ACCOUNT_SIZE, TICKS_ACCOUNT_TYPE, TOKEN_SWAP_ACCOUNT_SIZE, TOKEN_SWAP_ACCOUNT_TYPE, TickLayout, TokenSwap, TokenSwapAccountLayout, calculateLiquity, calculateLiquityOnlyA, calculateLiquityOnlyB, calculateLiquityTable, calculateSlidTokenAmount, calculateSwapA2B, calculateSwapB2A, calculateTokenAmount, cluster, createAssociatedTokenAccountInstruction, decimal128, decimal64, decimalU128, decimalU64, encodeDecode, getAssociatedTokenAddress, getNearestTick, getNearestTickByPrice, getNearestTickBySqrtPrice, getTokenAccount, getTokenAccounts, int128, int64, isPositionsAccount, isTicksAccount, isTokenSwapAccount, maxAmountA, maxAmountB, parsePositionsAccount, parseTicksAccount, parseTokenAccount, parseTokenAccountData, parseTokenSwapAccount, price2Tick, publicKey, sendAndConfirmTransaction, sqrtPrice2Tick, swapA2B, swapB2A, tick2Price, tick2SqrtPrice, uint128, uint64, url, urlTls, walletUrl };
